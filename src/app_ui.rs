...
fn load_glyph() -> &'static NbglGlyph<'static> {
    ...
    const APP_GLYPH: NbglGlyph = NbglGlyph::from_include(include_gif!("glyphs/zcash_48px.png", NBGL));
    #[cfg(any(target_os = "stax", target_os = "flex"))]
    const APP_GLYPH: NbglGlyph = NbglGlyph::from_include(include_gif!("glyphs/zcash_64px.png", NBGL));
    #[cfg(any(target_os = "nanosplus", target_os = "nanox"))]
    const APP_GLYPH: NbglGlyph = NbglGlyph::from_include(include_gif!("icons/nanox_app_zcash.gif", NBGL));
