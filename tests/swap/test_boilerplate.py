...
from application_client.zcash_command_sender import ZcashCommandSender, Errors as BoilerplateErrors
...
class BoilerplateTests(ExchangeTestRunner):
    ...
    def perform_final_tx(self, destination, send_amount, fees, memo):
        ...
        # Send the TX
        ZcashCommandSender(self.backend).sign_tx_sync(path=ZEC_PATH, transaction=tx)
